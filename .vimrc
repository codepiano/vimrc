...
" 转义行内的< >符号，支持range
noremap <silent> [x :HTMLEscapeLines<CR>
noremap <silent> ]x :HTMLUnescapeLines<CR>
...
"------------------------------------------------ 插件设置
" pathoen             按键绑定和设置
nmap <F6> :pathogen#helptags()<CR>                               " 生成帮助文档的tags
...
let g:vimrc_email = 'anyexingchen999@qq.com'
...
" buffergator         按键绑定和设置
let g:buffergator_viewport_split_policy = 'R'                     " 窗口位置
...
" zen coding          按键绑定和设置
let g:user_zen_expandabbr_key = '<c-e>'                           " 展开键绑定
...
" gundo               按键绑定和设置
nnoremap <F5> :GundoToggle<CR>                                    " 按键绑定
...
command -range -bar HTMLEscapeLines <line1>,<line2>s/&/\&amp;/ge|<line1>,<line2>s/</\&lt;/ge|<line1>,<line2>s/>/\&gt;/ge
command -range -bar HTMLUnescapeLines <line1>,<line2>s/&amp;/\&/ge|<line1>,<line2>s/&lt;/</ge|<line1>,<line2>s/&gt;/>/ge
